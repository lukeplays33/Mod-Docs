...
if (Object.keys(itemJSON.about.demoLinks).length != 0) {
    ...
    demo.src = Object.values(itemJSON.about.demoLinks)[0];
...
function loadDocItem(index) {
    ...
    variablesAndInfo.children[1].children[1].children[0].appendChild(createInfoTable(['description', 'outputValueOptions', 'inputValueOptions', 'type'], item));
