...
function loadDocItem(index) {
    ...
    variablesAndInfo.children[1].children[0].children[0].innerHTML = '';
    variablesAndInfo.children[1].children[0].children[0].appendChild(createInfoTable(itemName, item));
