let settings = {
    ...
    donations: { // daonations or subscription links
        ...
        globalMessage: { // allows the developer to set global support messages thatll appear above the download link.
            enabled: true,
            message: "Hey there, Thank you so much for taking a look at my module I hope you like it! <br> If ou like what I'm doing you can donate something to me to help keep me motivated you'll help the whole Thunkable community by doing so!",
        }
    },
