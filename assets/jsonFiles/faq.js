let faqItems = {
    ...
    "Why can't you create modules that have as much access as kodular components have e.g. device utilities vs deviceInfo?" : "This is sadly because of browser restrictions for security, Thunkable Modules access JS wich has some limitations compared to native code, sadly since we can't use native react code in modules there is no way to add more futures without restrictions.",
