let faqItems = {
    ...
    "Why are Modules not offline available?": "This is because there is no way in THunkable to set a web bridge from an offline source this means that we cannot download the files needed to use modules offline, The Javascript web bridge has no URL property wich is needed to load the source from an offline file."
