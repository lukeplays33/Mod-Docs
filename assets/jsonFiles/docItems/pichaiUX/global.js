let globalItemsPichaiUX = {
  about: {
    ...
    moduleInformation: {
      description: 'Here all global items are listed, these items can be applied to all elements',
      platforms: ['Web'],
      required: ['Pichai-UX'],
    ...
    notes: { // allows the develo.per or ai to supply additional notes such as bugs
    },
